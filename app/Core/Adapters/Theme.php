...
class Theme extends \App\Core\Theme
{
    ...
    public static function getOption($scope, $path = false, $default = null)
    {
        ...
        // Map the config path
        if (array_key_exists($scope, config('main'.'.general', []))) {
            $scope = 'general.'.$scope;
        }
        ...
        // Demo config
        $demoConfig = config('main.'.$scope.$deepPath, $default);
