...
return [
    ...
    */
    'bots' => [
        'solid-team-bot' => [
            'token' => env('TELEGRAM_SOLID_TEAM_BOT_TOKEN', 'YOUR-BOT-TOKEN'),
            'certificate_path' => env('TELEGRAM_SOLID_TEAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url' => env('TELEGRAM_SOLID_TEAM_WEBHOOK_URL', 'YOUR-BOT-WEBHOOK-URL'),
            'commands' => [
