                ...
                <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                    ...
                    <div style="text-align:center; margin:0 60px 34px 60px">
                        ...
                        <div style="font-size: 14px; font-weight: 500; margin-top: 27px; font-family:Tahoma,Helvetica,sans-serif;">
                            ...
                            <p style="margin-bottom:2px; color:#3F4254; line-height:1.6;font-family:Tahoma,Helvetica,sans-serif;">{{'تیکت شما با شماره ی '.convertNumbers($ticket->ticket_id).' دریافت شد و در حال
                                بررسی است.'}}</p>

                            <p style="margin-top:10px;color:#3F4254; line-height:1.6;font-family:Tahoma,Helvetica,sans-serif;">{{'همکاران ما در تلاشند تا در کم‌ترین فاصله زمانی
                                ممکن و با توجه به اولویت زمان دریافت، به تیکت شما پاسخ دهند. با این حال ممکن است به‌دلیل
                                حجم بالای تیکت‌ها، اندکی منتظر بمانید. تا آن زمان پیشنهاد می‌کنیم:'}}</p>
                        </div>
                        <!--end:Text-->
                    </div>
                    <!--end:Email content-->
