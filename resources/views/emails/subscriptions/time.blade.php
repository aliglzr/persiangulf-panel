            ...
            <tr>
                <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                    ...
                    <div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Tahoma,Helvetica,sans-serif;">
                        ...
                        <p style="font-family:Tahoma;margin-bottom:2px; color:black">کاربر گرامی؛<br>مهلت استفاده از اشتراک
                            {{$subscriptionName}} {{$subscriptionDuration}} روزه
                            {{$subscriptionTraffic}}  شما در ساعت
                            {{$endHour}} تاریخ
                            {{$endDate}} به پایان می رسد.<br>
