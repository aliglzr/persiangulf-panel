...
@php
    $items = [
        ...
        [
            ...
            'link-path' => theme()->getOption('product', 'preview') . '/layout-builder.html',
            'target' => '_blank',
        ],
        ...
        [
            ...
            'link-path' => theme()->getOption('product', 'preview') . '/documentation/base/utilities.html',
            'target' => '_blank',
        ],
        ...
        [
            ...
            'link-path' => theme()->getOption('product', 'preview') . '/documentation/forms/password-meter.html',
            'target' => '_blank',
        ],
        ...
        [
            ...
            'link-text' => 'Learn more',
            'link-path' => theme()->getOption('product', 'preview') . '/documentation/forms/flatpickr.html',
            'target' => '_blank',
        ],
        ...
        [
            ...
            'link-path' => theme()->getOption('product', 'preview') . '/documentation/general/icons/duotone.html',
            'target' => '_blank',
        ]
    ];
@endphp
