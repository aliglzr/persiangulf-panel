<div class="container-xxl">
    <div class="row">
        <div class="col-4">
            <svg class="bg-white p-4 rounded" width="350" viewBox="0 0 441 383" fill="none"
                ...
                <g id="XBox">
                    <path id="LOutline"
                          ...
                          stroke="hsl(210,50%,85%)" stroke-width="3" stroke-opacity="1"></path>
                    <path id="ROutline"
                          ...
                          stroke="hsl(210,50%,85%)" stroke-width="3" stroke-opacity="1"></path>
                    <circle id="LStickOutline" cx="113" cy="160" r="37.5" stroke="hsl(210,50%,85%)" stroke-opacity="1"
                            stroke-width="3"></circle>
                    <circle id="LeftStick" cx="113" cy="160" r="28" fill="rgba(0,0,0,0)"
                            stroke="rgba(0,0,0,1)" stroke-width="3"></circle>
                    <circle id="RStickOutline" cx="278" cy="238" r="37.5" stroke="hsl(210,50%,85%)" stroke-opacity="1"
                            stroke-width="3"></circle>
                    <circle id="RightStick" cx="278" cy="238" r="28" fill="rgba(0,0,0,0)" stroke="rgba(0,0,0,1)" stroke-width="3"></circle>
                    <circle id="DOutline" cx="166" cy="238" r="37.5" stroke="hsl(210,50%,85%)" stroke-opacity="1"
                            stroke-width="3"></circle>
                    <g id="DUp">
                        ...
                        <path id="DUpPath"
                            d="M177.669 222.335C180.793 219.21 180.816 213.997 176.868 212.014C176.327 211.743 175.776 211.491 175.215 211.258C172.182 210.002 168.931 209.355 165.648 209.355C162.365 209.355 159.114 210.002 156.081 211.258C155.521 211.491 154.969 211.743 154.429 212.014C150.48 213.997 150.503 219.21 153.627 222.335L159.991 228.698C163.116 231.823 168.181 231.823 171.305 228.698L177.669 222.335Z"
                            fill="rgba(0,0,0,0)" stroke="rgba(0,0,0,1)" stroke-width="6"
                            mask="url(#path-8-inside-1)"></path>
                    </g>
                    <g id="DRight">
                    ...
                    <g id="DLeft">
                        ...
                        <path id="DLeftPath"
                            ...
                            fill="rgba(0,0,0,0)" stroke="rgba(0,0,0,1)" stroke-width="6"
                            mask="url(#path-11-inside-4)"></path>
                    </g>
                    <circle id="BOutline" cx="329" cy="160" r="37.5" stroke="hsl(210,50%,85%)" stroke-opacity="1"
                            stroke-width="3"></circle>
                    <g id="BTop">
                        ...
                        <path id="BTopPath"
                            ...
                            fill="rgba(0,0,0,0)" stroke="rgba(0,0,0,1)" stroke-width="6"
                            mask="url(#path-13-inside-5)"></path>
                    </g>
                    <g id="BRight">
                        ...
                        <path id="BRightPath"
                            ...
                            fill="rgba(0,0,0,0)" stroke="rgba(0,0,0,1)" stroke-width="6"
                            mask="url(#path-14-inside-6)"></path>
                    </g>
                    <g id="BBottom">
                        ...
                        <path id="BBottomPath"
                            ...
                            fill="rgba(0,0,0,0)" stroke="rgba(0,0,0,1)" stroke-width="6"
                            mask="url(#path-15-inside-7)"></path>
                    </g>
                    <g id="BLeft">
                        ...
                        <path id="BLeftPath"
                            ...
                            fill="rgba(0,0,0,0)" stroke="rgba(0,0,0,1)" stroke-width="6"
                            mask="url(#path-16-inside-8)"></path>
                    </g>
                    <g id="LMeta">
                        <circle id="LMetaCircle"  cx="185" cy="162" r="10" fill="rgba(0,0,0,0)" stroke="rgba(0,0,0,1)"
                                stroke-width="3"></circle>
                    </g>
                    <g id="RMeta">
                        <circle id="RMetaCircle" cx="259" cy="162" r="10" fill="rgba(0,0,0,0)" stroke="rgba(0,0,0,1)"
                                stroke-width="3"></circle>
                    </g>
                    <rect id="L1" x="111.5" y="61.5" width="41" height="13" rx="6.5" fill="rgba(0,0,0,0)"
                          stroke="rgba(0,0,0,1)" stroke-width="3"></rect>
                    <rect id="R1" x="289.5" y="61.5" width="41" height="13" rx="6.5" fill="rgba(0,0,0,0)"
                          stroke="rgba(0,0,0,1)" stroke-width="3"></rect>
                    <path id="L2"
                    ...
                    <path id="R2"
                          ...
                          fill="rgba(0,0,0,0)" stroke="rgba(0,0,0,1)" stroke-width="3"></path>
                    <line x1="30" y1="210" x2="130" y2="300" stroke-width="3" stroke="hsl(210,50%,85%)"
                          opacity="0.3"></line>
                    <line x1="411" y1="210" x2="311" y2="300" stroke-width="3" stroke="hsl(210,50%,85%)"
                          opacity="0.3"></line>
                </g>
            </svg>
        </div>
    ...
    <script>
        ...
        function controllerInput() {
            if (controllerIndex !== null) {
                ...
                const axes2 = gamepad.axes[2];
                const axes3 = gamepad.axes[3];
                const green = gamepad.buttons[0].pressed;
                const red = gamepad.buttons[1].pressed;
                const blue = gamepad.buttons[2].pressed;
                const orange = gamepad.buttons[3].pressed;
                const l1 = gamepad.buttons[4].pressed;
                const r1 = gamepad.buttons[5].pressed;
                const l2 = gamepad.buttons[6].value;
                const r2 = gamepad.buttons[7].value;
                const back = gamepad.buttons[8].pressed;
                const start = gamepad.buttons[9].pressed;
                const leftShock = gamepad.buttons[10].pressed;
                const rightShock = gamepad.buttons[11].pressed;
                ...
                let gamePadCommandObject = {
                    axes0: readyAxesNumbers(axes0),
                    axes1: readyAxesNumbers(axes1),
                    axes2: readyAxesNumbers(axes2),
                    axes3: readyAxesNumbers(axes3),
                    green: green,
                    red: red,
                    blue: blue,
                    orange: orange,
                    l1: l1,
                    r1: r1,
                    l2: readyAxesNumbers(l2),
                    r2: readyAxesNumbers(r2),
                    back: back,
                    start: start,
                    leftShock: leftShock,
                ...
                document.getElementById('R2').setAttribute('fill', 'rgba(0,0,0,'+ r2 + ')')
                document.getElementById('L2').setAttribute('fill', 'rgba(0,0,0,'+ l2 + ')')
                document.getElementById('BTopPath').setAttribute('fill', 'rgba(0,0,0,'+ (orange ? '1' : '0')  + ')')
                document.getElementById('BRightPath').setAttribute('fill', 'rgba(0,0,0,'+ (red ? '1' : '0')  + ')')
                document.getElementById('BBottomPath').setAttribute('fill', 'rgba(0,0,0,'+ (green ? '1' : '0')  + ')')
                document.getElementById('BLeftPath').setAttribute('fill', 'rgba(0,0,0,'+ (blue ? '1' : '0')  + ')')
                document.getElementById('DUpPath').setAttribute('fill', 'rgba(0,0,0,'+ (up ? '1' : '0')  + ')')
                document.getElementById('DRightPath').setAttribute('fill', 'rgba(0,0,0,'+ (right ? '1' : '0')  + ')')
                document.getElementById('DDownPath').setAttribute('fill', 'rgba(0,0,0,'+ (down ? '1' : '0')  + ')')
                document.getElementById('DLeftPath').setAttribute('fill', 'rgba(0,0,0,'+ (left ? '1' : '0')  + ')')
                document.getElementById('RMetaCircle').setAttribute('fill', 'rgba(0,0,0,'+ (start ? '1' : '0')  + ')')
                document.getElementById('LMetaCircle').setAttribute('fill', 'rgba(0,0,0,'+ (back ? '1' : '0')  + ')')
                document.getElementById('R1').setAttribute('fill', 'rgba(0,0,0,'+ (r1 ? '1' : '0')  + ')')
                document.getElementById('L1').setAttribute('fill', 'rgba(0,0,0,'+ (l1 ? '1' : '0')  + ')')
                document.getElementById('LeftStick').setAttribute('fill', 'rgba(0,0,0,'+ (leftShock ? '1' : '0')  + ')')
                document.getElementById('RightStick').setAttribute('fill', 'rgba(0,0,0,'+ (rightShock ? '1' : '0')  + ')')
                if(!leftShock){
                    if (Math.abs(axes0) > 0.20 || Math.abs(axes1) > 0.20) {
                        document.getElementById('LeftStick').setAttribute('fill', 'rgba(0,0,0,' + (Math.max(Math.abs(axes0), Math.abs(axes1))) + ')')
                    } else {
                        document.getElementById('LeftStick').setAttribute('fill', 'rgba(0,0,0,' + (0) + ')')
                    }
                }
                if(!rightShock){
                    if (Math.abs(axes2) > 0.20 || Math.abs(axes3) > 0.20) {
                        document.getElementById('RightStick').setAttribute('fill', 'rgba(0,0,0,' + (Math.max(Math.abs(axes2), Math.abs(axes3))) + ')')
                    } else {
                        document.getElementById('RightStick').setAttribute('fill', 'rgba(0,0,0,' + (0) + ')')
                    }
                }
                document.getElementById('LeftStick').setAttribute('cy', 160 + (axes1 * 12));
                document.getElementById('LeftStick').setAttribute('cx', 113 + (axes0 * 20));
                document.getElementById('RightStick').setAttribute('cy', 238 + (axes3 * 12));
                document.getElementById('RightStick').setAttribute('cx', 278 + (axes2 * 20));
                if(connection.readyState !== WebSocket.CLOSED) {
                    connection.send(JSON.stringify(gamePadCommandObject));
                }
            }
        }
