            ...
            <tr>
                <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                    ...
                    <div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Tahoma,Helvetica,sans-serif;">
                        <p style="font-family:Tahoma;margin-bottom:9px; color:#181C32; font-size: 16px; font-weight:bold">اطلاعیه حجم اشتراک</p>
                        <p style="font-family:Tahoma;margin-bottom:2px; color:black">کاربر گرامی؛<br>شما تا ساعت
                            {{$nowHour}} تاریخ
                            {{$nowDate}} بیش از ۸۰ درصد از حجم بسته
                            {{$subscriptionName}} {{$subscriptionTraffic}}
                            {{$subscriptionDuration}} روزه را مصرف کرده اید و تنها
                            {{$subscriptionRemainedTraffic}} از حجم اشتراک شما باقی مانده است.<br>
                            پس از به پایان رسیدن اشتراک، در صورت نداشتن اشتراک رزرو اتصال شما به وی پی ان قطع خواهد شد.
                        </p>
                    </div>
                </td>
            </tr>
