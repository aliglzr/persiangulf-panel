        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" height="auto"
            ...
            <tr>
                <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                    ...
                    @php
                        $prefix = $timeEnd ? "مهلت زمانی اشتراک" : "حجم اشتراک";
                    @endphp
                    <div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Tahoma,Helvetica,sans-serif;">
                        <p style="font-family:Tahoma;margin-bottom:9px; color:#181C32; font-size: 16px; font-weight:bold">اطلاعیه مهلت زمانی اشتراک</p>
                        <p style="font-family:Tahoma;margin-bottom:2px; color:black">کاربر گرامی؛<br>
                            {{$prefix}} {{$subscriptionName}} {{$subscriptionTraffic}} {{$subscriptionDuration}} روزه شما به پایان رسید.
                            <br>
                            در صورت داشتن اشتراک رزرو، آن اشتراک به طور خودکار برای شما فعال خواهد شد و در غیر این صورت اتصال شما قطع می شود.
                        </p>
                    </div>
                </td>
            </tr>
