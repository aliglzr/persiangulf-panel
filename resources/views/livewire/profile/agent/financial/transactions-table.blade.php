...
@push('scripts')
    ...
    <script type="text/javascript">$(function(){window.LaravelDataTables=window.LaravelDataTables||{};window.LaravelDataTables["transactions-table"]=$("#transactions-table").DataTable({"serverSide":true,"processing":true,"ajax":{"url":"{{route('agents.transactions',$user)}}","type":"GET","data":function(data) {
