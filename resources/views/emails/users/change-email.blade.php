            ...
            <tr>
                <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                    ...
                    <div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Tahoma,Helvetica,sans-serif;">
                        <p style=" font-family:Tahoma,Helvetica,sans-serif;margin-bottom:9px; color:#181C32; font-size: 16px; font-weight:bold">تغییر آدرس ایمیل به {{$user->getData('temp_mail')}}</p>
                        <p style=" font-family:Tahoma,Helvetica,sans-serif;margin-bottom:2px; color:black">کاربر گرامی، جهت تغییر آدرس ایمیل خود لطفا روی دکمه زیر کلیک کنید.</p>
                    </div>


                    <a href="{{$url}}"
                       target="_blank"
                       style="text-decoration:none; background-color:#009ef7; border-radius:6px;display:inline-block; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500; font-family:Tahoma,Helvetica,sans-serif;">تایید تغییر ایمیل به {{$user->getData('temp_mail')}}</a>
                    ...
                    <p style=" font-family:Tahoma,Helvetica,sans-serif;color:#181C32; font-size: 15px; font-weight: 500; margin-top:15px">در صورتی که دکمه بالا برای شما غیر فعال است می توانید روی لینک زیر کلیک کنید یا لینک را کپی و داخل آدرس بار مرورگرتان وارد کنید.</p>
                        <a href="{{$url}}" style="text-decoration:none; font-size: 15px; font-weight: 500; margin-bottom:15px">{{$url}}</a>
                    <!--end:Email content-->
                </td>
            </tr>
