...
class TimeSubscriptionNotification extends Notification implements ShouldQueue,ShouldBroadcast
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject('اطلاعیه مهلت زمانی اشتراک')
            ->mailer('no-reply')
            ...
            ->view('emails.subscriptions.time',[
    ...
    {
        return [
            'title' => 'مهلت زمانی اشتراک',
            'body' => "مهلت استفاده از اشتراک $this->subscriptionName $this->subscriptionDuration روزه $this->subscriptionTraffic  شما در ساعت $this->endHour تاریخ $this->endDate به پایان می رسد.",
            'toast_type' => 'warning',
