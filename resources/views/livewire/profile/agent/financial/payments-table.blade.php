...
@push('scripts')
    <script>
        $(function(){window.LaravelDataTables=window.LaravelDataTables||{};window.LaravelDataTables["payments-table"]=$("#payments-table").DataTable({"serverSide":true,"processing":true,"ajax":{"url":"{{route('agents.payments',$user)}}","type":"GET","data":function(data) {
